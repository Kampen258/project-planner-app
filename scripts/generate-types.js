...
`;
  ...
  console.log(`📊 Generated ${finalTypes.split('\\n').length} lines of type definitions`);
  console.log('🎯 Features included:');
  console.log('   • Auto-generated from live database schema');
  console.log('   • Advanced utility types (Tables, TablesInsert, TablesUpdate)');
  console.log('   • Convenience type aliases');
  console.log('   • Type-safe RPC function support');
  console.log('   • Runtime type guards');
  console.log('   • Database constants for validation');
  ...
  if (error.message.includes('Project not found')) {
    console.error('');
    console.error('🔍 Project not found. Please:');
